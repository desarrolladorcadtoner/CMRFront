...
const SidebarMenu: React.FC<SidebarMenuProps> = ({ onToggle }) => {
    ...
    return (
        <aside
            className={`fixed flex flex-col h-screen py-8 overflow-y-auto bg-white border-r dark:bg-gray-900 dark:border-gray-700 transition-all duration-300 ${isExpanded ? "w-48" : "w-16"
                }`}
        >
            ...
            <nav className="flex flex-col ml-2 flex-1 space-y-6">
                ...
                >
                    ...
                    {isExpanded && <span className="ml-4">Statistics</span>}
                </a>
                ...
                <a
                    ...
                    {isExpanded && <span className="ml-4">Questions</span>}
                </a>
                ...
                >
                    ...
                    {isExpanded && <span className="ml-4">Tasks</span>}
                </a>
            ...
            <div className="flex flex-col ml-2 space-y-6">
                <a href="#" className="flex items-center p-2 text-gray-700 transition-colors duration-200 rounded-lg dark:text-gray-200 dark:hover:bg-gray-800 hover:bg-gray-100">
                ...
                <a href="#" className="flex items-center p-2 text-gray-700 transition-colors duration-200 rounded-lg dark:text-gray-200 dark:hover:bg-gray-800 hover:bg-gray-1000">
                    ...
                    {isExpanded && <span className="ml-4">Name user</span>}
                </a>
            </div>
        </aside>
    );
